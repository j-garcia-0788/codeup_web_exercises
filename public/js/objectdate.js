...
var months = ['January', 'February', 'March', 'April', 'May',
			  ...
			  var jsBirthday = new Date(1988, 6, 19);
			  var numMonth = jsBirthday.getMonth();
			  var numDay = jsBirthday.getDay();
...
// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date#Getter
 console.log('Here is my birthday using vanilla js: ' + jsBirthday);
...
var now = moment([1988, 7, 19]);

var bday = bday.format("MMMM DD, YYYY");
